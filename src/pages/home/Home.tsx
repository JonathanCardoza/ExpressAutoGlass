...
export function Home(): JSX.Element {
  const content = `Allow me to introduce myself, I'm George, an expert in the realm of
          ...
          deep-rooted passion for cars and the intricate craftsmanship involved
          ...
          model on the market, I approach each job with meticulous attention to
