...
export function Home() {
  ...
  return (
    ...
    <div className="column">
      <p>
        Allow me to introduce myself, I'm Geroge, an expert in the realm
        of car window replacements, with an impressive 41 years of hands-on experience. 
        ...
        involved in replacing their windows ignited my journey four decades ago. Since then, I've 
        ...
        What truly sets me apart is my dedication to customer satisfaction. I understand the 
        frustration and inconvenience that comes with a damaged car window, which is why I always strive 
        to provide swift and reliable solutions. Whether it's a vintage classic, exotic cars, or the newest model on the market, 
